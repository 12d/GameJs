...
function Class(proto){
    function NewClass(options){
        ...
        NewClass.prototype.constructor.call(this, options);
    }
...
Class.INTERFACES = {
    ...
    'attr': {
        ...
        get: function(key){
            return (attrsMap[this.__guid]||{})[key]||undefined;
        }
    }
}
